    ...
    return (
        <>
            <img
                src={imageBase64}
                alt="QR Code"
                className="w-full max-w-[150px] sm:max-w-[200px] lg:max-w-[240px] h-auto object-contain rounded-lg border border-gray-300 shadow-md my-2 animation-bounce-in-2s"
            />
